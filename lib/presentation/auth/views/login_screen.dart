...
class LoginScreen extends GetView<LoginController> {
  ...
  static const Color primaryBlue = Color(0xFF075BED);
  static const Color deepBlue = Color(0xFF020F3D);
  static const Color mutedText = Color(0xFF696D91);
  static const Color fieldBorder = Color(0xFF85ACFF);
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color(0xFF79A9FF).withOpacity(0.28),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10 * scale),
                    Text(
                      'Login to your Lite Xpress account',
                      style: TextStyle(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [Color(0xFF0669FF), Color(0xFF003ED8)],
...
class _LoginBackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const deepBlue = Color(0xFF003DCC);
  ...
  void _drawBottomScene(Canvas canvas, Size size, Color blue, Color deepBlue) {
    ...
    final gradientPaint = Paint()
      ..shader = LinearGradient(
        ...
        colors: [
          const Color(0xFF8FC4FF).withOpacity(0.20),
          const Color(0xFF0875FF).withOpacity(0.88),
    ...
    final shipPaint = Paint()..color = const Color(0xFF003DAD).withOpacity(0.78);
    final ship = Path()
    ...
    canvas.drawRRect(
      ...
      Paint()..color = const Color(0xFF0A67E8).withOpacity(0.55),
    );
    for (var i = 0; i < 4; i++) {
      ...
      canvas.drawRect(
        ...
        Paint()..color = const Color(0xFF2EA1FF).withOpacity(0.42),
      );
    }
    ...
    final routePaint = Paint()
      ..color = const Color(0xFF56D6FF).withOpacity(0.75)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1.5;
    final route = Path()
    ...
    canvas.drawCircle(pinCenter, 10, Paint()..color = const Color(0xFF54D8FF));
